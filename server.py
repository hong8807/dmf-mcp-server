...
9. 텍스트 검색은 반드시 str.contains()를 사용하세요! == 정확 일치 절대 금지!
   성분명, 신청인, 제조소명, 제조국가 검색 시 항상:
   df[df['성분명'].str.contains('키워드', case=False, na=False)]
   이유: "에피나스틴"으로 검색하면 "에피나스틴염산염"도 포함되어야 함
